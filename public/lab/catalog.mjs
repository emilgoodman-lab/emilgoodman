...
export const works=Object.freeze([
 ...
 {id:'rotor',title:'Rotor II',edition:'Painted Resonator',description:'Twenty-eight painted ornament rings. Four fields, deep shadows and modulated strings.',path:'/experiments/rotor/v2/',input:'MOUSE · TOUCH · HAND',audio:true,immersive:true},
