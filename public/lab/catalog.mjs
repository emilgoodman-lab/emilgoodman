...
export const works=Object.freeze([
 ...
 {id:'strata',title:'Strata I',edition:'Sand Table',description:'Three independent glyph-sand layers. Sweep or summon a turbulent wind.',path:'/experiments/strata/v1/',input:'MOUSE · TOUCH · HAND',audio:true}
]);
