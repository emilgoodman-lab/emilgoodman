...
export const works=Object.freeze([
 ...
 {id:'rotor',title:'Rotor IV',edition:'Ten Rings',description:'Ten opaque painted rings. Full-strength double-intensity motion, fixed octagonal boundary and classic controls.',path:'/experiments/rotor/v4/',input:'MOUSE · TOUCH · HAND',audio:true,immersive:true},
