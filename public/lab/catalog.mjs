...
export const works=Object.freeze([
 ...
 {id:'rotor',title:'Rotor V',edition:'Swimmers',description:'Fourteen painted rings. Two synchronized swimmer orbits drift into delayed waves.',path:'/experiments/rotor/v5/',input:'MOUSE · TOUCH · HAND',audio:true,immersive:true},
