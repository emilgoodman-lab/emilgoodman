...
export const works=Object.freeze([
 ...
 {id:'rotor',title:'Rotor III',edition:'Octagonal Resonator',description:'A fixed ornamental octagon dissolves into circular rings. Mixed scale paper pieces and restrained agitation.',path:'/experiments/rotor/v3/',input:'MOUSE · TOUCH · HAND',audio:true,immersive:true},
