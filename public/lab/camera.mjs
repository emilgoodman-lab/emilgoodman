import {describeHand,FistLatch} from '../experiments/organic/v4/hand-math.mjs';
...
async function start(){
  ...
  try{
    ...
    worker=new Worker(new URL('../experiments/organic/v4/hand-worker.js',import.meta.url),{type:'module'});
    ...
    worker.onmessage=({data})=>{
      ...
      if(data.type==='ready'){
        ...
        status.textContent=fist?'TRACKING / FIST / HOLD':'TRACKING / OPEN HAND';
