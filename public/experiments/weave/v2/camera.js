...
async function start(){
  ...
  button.textContent='[ CANCEL CAMERA ]';button.setAttribute('aria-pressed','true');status.textContent='Allow camera access to begin. No microphone is used.';
  try{
    ...
    worker.onmessage=({data})=>{
      ...
      if(data.type==='ready'){
        ...
        status.textContent=fist?'TRACKING / FIST / ELASTIC KNOT':'TRACKING / OPEN HAND / WAVE';
